...
namespace util
{
	static constexpr int gPrimeNumbers[] = {
		...
		5839, 7013, 8419, 10103, 12143, 14591, 17321, 21269,
		25253, 31393, 39769, 49157, 62851, 90523, 108631, 130363, 156437,
		187751, 225307, 270371, 324449, 389357, 467237, 560689, 672827, 807403, 946037,
		1395263, 1572869, 2009191, 2411033, 2893249, 3471899, 4166287, 4999559, 5999471, 7199369
	};
	...
	static inline int Hash(char* c, int sz)
	{
		return (int)murmur::MurmurHash3_x86_32(c, sz);
	}
	...
	{ 
		...
		{ 
#ifdef ECSCORE_x64
			return murmur::MurmurHash3_x86_32(str.data(), str.size());
#else
			return fnv1a(str);
#endif
		}
	...
	{  
		static inline int Hash(const std::string& str)
		{
			return (int)std::hash<std::string>{}(str); 
		} 
	};
	struct SHash_FNV1a
	{
